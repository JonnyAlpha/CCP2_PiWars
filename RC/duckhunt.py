    ...
    while running:
        ...
        for event in events:
            if event.type == pygame.QUIT:
                ...
                hadEvent = True
            if hadEvent:
                if joystick.get_button(fire):
                    #Insert servo trigger code here
                    #Servo will need tuning to ensure full trigger press and release
                ...
                driveRight = driveRight * 0.8
                driveLeft = driveLeft * 0.6

                # Set the motors to the new speeds
                TB.SetMotor1(driveRight * maxPower)
                TB.SetMotor2(driveLeft * maxPower)
                #Poss enter servo control here
                #insert fire button here from jstest /dev/input
